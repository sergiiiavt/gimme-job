...
export const catalog = {
  ...
  topics: [
    ...
    ),
    {
      ...
      description: "HTTP semantics for APIs: messages, URLs, methods, REST constraints, headers, status codes, credentials and sessions, request bodies and files, caching, retries and CORS.",
      descriptionUk: "HTTP semantics для APIs: messages, URLs, methods, REST constraints, headers, status codes, credentials і sessions, request bodies та files, caching, retries і CORS.",
