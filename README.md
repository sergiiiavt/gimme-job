# JobPilot — локальний агент пошуку роботи

JobPilot збирає вакансії в один feed, видаляє дублікати, аналізує вимоги й ринкові тенденції, адаптує резюме без вигаданих фактів та готує заявки. Надсилання завжди залишається під вашим контролем.
