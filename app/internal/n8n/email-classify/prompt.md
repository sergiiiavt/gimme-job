# GimmeJob email classifier prompt

Prompt version: `email-classifier-v2`

This file is the human-readable review copy of the runtime instruction in `instructions.ts`.
