...
export const REWILD_DETAIL_V4_FRAMES: Record<RewildDetailV4Id, RewildDetailV4Frame> = {
  ...
  "detail-grass-tuft-b": { x: 160, y: 43, width: 63, height: 42, pivotX: 0.5, pivotY: 0.92 },
  "detail-grass-tuft-c": { x: 288, y: 41, width: 63, height: 46, pivotX: 0.5, pivotY: 0.92 },
  "detail-wild-weeds": { x: 408, y: 30, width: 79, height: 68, pivotX: 0.5, pivotY: 0.92 },
  ...
  "detail-rock-small-a": { x: 289, y: 171, width: 61, height: 43, pivotX: 0.5, pivotY: 0.92 },
  ...
  "detail-log-a": { x: 655, y: 163, width: 98, height: 57, pivotX: 0.5, pivotY: 0.92 },
  "detail-stump-a": { x: 26, y: 300, width: 75, height: 40, pivotX: 0.5, pivotY: 0.92 },
  "detail-shrub-low-a": { x: 157, y: 296, width: 70, height: 49, pivotX: 0.5, pivotY: 0.92 },
  ...
  "industrial-pipe-outlet-a": { x: 142, y: 413, width: 100, height: 70, pivotX: 0.5, pivotY: 0.92 },
