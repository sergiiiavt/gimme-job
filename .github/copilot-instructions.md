...
- Run `npm run check:content`, `npm run check:rewild-assets`, `npm run lint`, `npm run check:agent`, `npm run build`, `node --test`, and `npm run check:cloudflare` before publishing.
