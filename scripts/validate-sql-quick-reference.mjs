...
const portableText = JSON.stringify(catalog.cards.filter((card) => card.dialects.includes("Portable")));
...
console.log(`SQL quick reference validation passed: ${catalog.cards.length} compact cards`);
