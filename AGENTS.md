...
- Interview content is additive. Preserve every existing question ID and title unless the user explicitly approves a correction. The current 602-question validation floor is a rolling minimum, never a target or maximum.
